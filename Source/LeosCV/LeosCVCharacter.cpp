...
ALeosCVCharacter::ALeosCVCharacter()
{
...
void ALeosCVCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("Turn Right / Left Gamepad", this, &ALeosCVCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("Look Up / Down Mouse", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("Look Up / Down Gamepad", this, &ALeosCVCharacter::LookUpAtRate);
...
void ALeosCVCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void ALeosCVCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
